...
/** Phase 1 stand-in — enderman geometry. Selected when useCustomModels=false. */
public class AlienLegacyRenderer extends BipedEntityRenderer<AlienEntity, EndermanEntityModel<AlienEntity>> {
	private static final Identifier TEXTURE = Identifier.of(Hatchling.MOD_ID, "textures/entity/alien.png");

	public AlienLegacyRenderer(EntityRendererFactory.Context context) {
